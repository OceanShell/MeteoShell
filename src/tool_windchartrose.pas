...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, DateUtils, Buttons, SQLDB, db;
...
begin
 ...
 Qt1.Transaction:=TRt1;
   ...
   for k:=1 to 2 do begin
     ...
     case k of
       1: tbl_spd:=Qt1.Fields[0].Value;
       2: tbl_dir:=Qt1.Fields[0].Value;
     end;
   end;
 Qt1.Close;
 Qt1.Free;
 ...
 with Qt2 do begin
   ...
   while not Qt2.Eof do begin
    time1:=Qt2.FieldByName('dat1').AsDateTime;
    wnd  :=Qt2.FieldByName('wnd').AsFloat;
    dir  :=Qt2.FieldByName('dir').AsFloat;
