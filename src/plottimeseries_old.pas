...
type
  Tfrmplottimeseriesold = class(TForm)
...
var
  frmplottimeseriesold: Tfrmplottimeseriesold;
  f_dat:text;
  tspath:string;

implementation

uses main, dm, monthlymatrix, procedures, grapher;

{$R *.lfm}


procedure Tfrmplottimeseriesold.FormShow(Sender: TObject);
begin
 tspath:=GlobalPath+'unload\timeseries\';
 //if frmViewData.PageControl1.PageIndex=1 then rgPlotType.;
end;

procedure Tfrmplottimeseriesold.btnPlotClick(Sender: TObject);
begin
...
procedure Tfrmplottimeseriesold.rgPlotTypeClick(Sender: TObject);
begin
 case rgPlotType.ItemIndex of
...
procedure Tfrmplottimeseriesold.btnShowDataClick(Sender: TObject);
begin
...
procedure Tfrmplottimeseriesold.GetMonthComposition;
var
...
procedure Tfrmplottimeseriesold.GetSelectedMonth;
var
