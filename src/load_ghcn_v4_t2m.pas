...
//ACW000116041962TAVG   60  k   32  k -207  k  582  k  855  k 1328  k 1457  k 1340  k 1110  k  941  k  270  k -179  k
 ...
 repeat
  ...
  // application.ProcessMessages;
   ...
   with db1q1 do begin
    ...
    Open;
      if db1q1.IsEmpty=false then
        absnum:=db1q1.FieldByName('id').AsInteger else absnum:=-9;
    Close;
   end;
 ...
 //   try
    ...
    if db2q1.IsEmpty=true then begin
      with db2q2 do begin
        Close;
         SQL.Clear;
    ...
    // updating existing
    if db2q1.IsEmpty=false then begin
     if db2q1.Fields[0].Value<>temp then begin
      with db2q2 do begin
        Close;
          SQL.Clear;
